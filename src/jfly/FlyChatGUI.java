...
/**
 * The FlyChatGUI extends JFrame and is the main user interface component for
 * the JFly chat program.
 *
...
//-------------------------------------------------------------------------------------------
        ...
        menuItem.setFont(fnt2);
        menuItem2.setFont(fnt2);
...
//--------------------------------------------------------------------------------------------------------------------   
    /**
     * The ListenForButton class implements ActionListener and KeyListener, and
     * contains methods to handle ActionEvents generated by the GUI.
     */
